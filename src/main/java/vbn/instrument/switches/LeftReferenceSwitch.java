...
public class LeftReferenceSwitch extends AbstractReferenceSwitch {
    ...
    public LeftReferenceSwitch(InstrumentData data, int lineNumber, boolean isReturn) {
        super(data);
        method = data.runtime.getMethod(isReturn ? "finalizeReturn" : "finalizeStore", List.of(
